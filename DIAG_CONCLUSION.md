...
## Verification
- Phase A-C: CSS loaded, route correct, no covering elements, probe renders (see `__project_support/diagnostics/rendering/a_loaded_styles.json`, `__project_support/diagnostics/rendering/b_style_dump_chromium.json`, `__project_support/diagnostics/rendering/b_style_dump_webkit.json`, `__project_support/diagnostics/rendering/c_covering_elements_chromium.json`, `__project_support/diagnostics/rendering/c_covering_elements_webkit.json`).
- Phase D: Animation active in both engines, timing not the issue (`__project_support/diagnostics/rendering/d_style_dump_chromium.json`, `__project_support/diagnostics/rendering/d_style_dump_webkit.json`).
- Phase E: Gradient is now on `.global-gradient` in both engines (`__project_support/diagnostics/rendering/f_style_dump_chromium.json`, `__project_support/diagnostics/rendering/f_style_dump_webkit.json`); final screenshots saved to `__project_support/diagnostics/rendering/f_final_chromium.png` and `__project_support/diagnostics/rendering/f_final_webkit.png`.
