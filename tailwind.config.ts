...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        glass:
          "0 1px 0 rgba(255,255,255,0.06) inset, 0 10px 40px rgba(0,170,255,0.08)",
      },
      backgroundImage: {
        "radial-grid":
          "radial-gradient(circle at 50% 50%, rgba(255,255,255,0.06) 0, rgba(255,255,255,0.04) 1px, transparent 1px)",
      },
      backgroundSize: {
        grid: "24px 24px",
      },
