...
export const metadata = {
  ...
  description: copyWebSystems.hero.subtitle,
};
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-16 sm:py-24 space-y-24">
      <section className="grid gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] items-center">
        ...
        <FadeIn>
          <VideoPlaceholder
            label="Web system architecture reel"
            ratio="aspect-[16/10]"
          />
        </FadeIn>
      </section>
      ...
      <section className="space-y-8">
        <FadeIn>
          ...
          <p className="mt-3 max-w-3xl text-sm text-mute sm:text-base">
            Every deliverable pairs structure, proof, and instrumentation so the
            site ships fast and remains measurable.
          </p>
        </FadeIn>
      ...
      <section className="space-y-8">
        <FadeIn>
          ...
          <p className="mt-3 max-w-3xl text-sm text-mute sm:text-base">
            The build cadence keeps proof, performance, and rollback discipline
            connected from first map to final launch.
          </p>
        </FadeIn>
