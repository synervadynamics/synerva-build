export const metadata = {
  ...
  description: "Under the hood of the Verisense/Syndicate ecosystem.",
};
    ...
    <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
      ...
      <div className="mt-8 space-y-6">
        ...
        <section>
          ...
          <p className="mt-2 text-neutral-300">
            The reasoning layer — orchestrates multi-prompt operations and
            memory state across creative and analytical tasks.
          </p>
        </section>
        <section>
