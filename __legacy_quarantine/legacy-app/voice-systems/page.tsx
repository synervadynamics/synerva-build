    ...
    <div className="mx-auto max-w-6xl px-4 py-16 sm:py-24 space-y-24">
      ...
      <section className="grid gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.8fr)]">
        ...
        <FadeIn className="grid gap-6 sm:grid-cols-2">
          <VideoPlaceholder
            label="Brand Voice Card mockup"
            ratio="aspect-[4/5]"
          />
          <VideoPlaceholder
            label="Messaging House storyboard"
            ratio="aspect-[4/5]"
          />
        </FadeIn>
      </section>
      ...
      <section className="space-y-8">
        <FadeIn>
          ...
          <p className="mt-3 max-w-3xl text-sm text-mute sm:text-base">
            Each component locks rhythm, lexicon, and proof so brand voice holds
            across every asset and channel.
          </p>
        </FadeIn>
      ...
      <section className="space-y-8">
        <FadeIn>
          ...
          <p className="mt-3 max-w-3xl text-sm text-mute sm:text-base">
            Engagements move in disciplined stages—each unlocking a
            ready-to-ship asset and a measurable proof point.
          </p>
        </FadeIn>
