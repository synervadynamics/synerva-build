export const copyVoiceSystems = {
  ...
  overview: {
    oneLiner:
      "Voice is infrastructure. Rules, rhythm, and proof—applied everywhere.",
    bullets: [
  ...
  modules: [
    {
      ...
      text: "Traits, tone base, rhythm (60/30/10), syntax discipline, humanity protocol, and banned-lexicon rules in one reference.",
    },
    {
      title: "Messaging House",
      text: "Promise, pillars, and proof lines that anchor headlines, subheads, CTAs, and case narration.",
    },
    {
      title: "Lexicon & Banned Terms",
      text: "Canonical wordlist with Canadian variants; forbidden terms replaced with plain-language alternatives.",
    },
    {
      title: "Syntax Patterns",
      text: "Reusable sentence scaffolds by tone mode—Strategic, Magnetic, Clean, Technical, Conversational.",
    },
    {
      title: "Acceptance & QA",
      text: "Pre-publish checklist: rhythm ratio, banned words, en-CA spelling, proof near claim, accessibility, rollback note.",
    },
  ],
  process: [
    {
  ...
  faq: [
    {
      ...
      a: "Rhythm, syntax patterns, and lexicon controls run at brief and QA stages; nothing ships before passing checks.",
    },
    {
      q: "What compliance and accessibility standards apply?",
      a: "en-CA spelling, CASL/PIPEDA awareness, and accessibility checks attach to the Voice QA.",
    },
    {
      q: "Does automation make copy robotic?",
      a: "Patterns enforce clarity while the humanity protocol preserves natural cadence and respect for the reader.",
    },
  ],
  cta: {
