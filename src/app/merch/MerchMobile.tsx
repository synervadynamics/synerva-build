...
export default function MerchMobile() {
  return (
    <main className={pageStyles.merchPage}>
      ...
      >
        <section className="mt-6 flex flex-col gap-5 rounded-[2rem] border border-[color:var(--merch-outline-primary)] bg-[color:var(--merch-panel-fill)] px-5 py-6">
          <div
            aria-hidden
        ...
        <section className="flex flex-col gap-5 rounded-[2rem] border border-[color:var(--merch-outline-secondary)] bg-[color:var(--merch-panel-fill)] px-5 py-6">
          <div
            aria-hidden
            className="relative aspect-[3/2] w-full overflow-hidden rounded-2xl border border-[color:var(--merch-outline-secondary)] bg-[color:var(--merch-panel-fill)] max-h-[40vh] sm:max-h-none"
          >
        ...
        <section className="flex flex-col gap-5 rounded-[2rem] border border-[color:var(--merch-outline-secondary)] bg-[color:var(--merch-panel-fill)] px-5 py-6">
          ...
          <Link
            href="/#preview-access"
            className="inline-flex w-fit rounded-full border border-[color:var(--merch-cta-outline)] bg-[color:var(--merch-cta-outline)] px-5 py-2.5 text-[0.78rem] font-semibold uppercase tracking-wide text-[color:var(--merch-cta-text)] transition hover:opacity-90"
          >
            Join the Drop List
          </Link>
        </section>
