...
export default function SystemsMobileShell({
  children,
  showBackButton = false,
  backgroundImageUrl,
  backgroundOverlayEnabled = true,
  backgroundOverlayOpacity = 1,
}: SystemsMobileShellProps) {
  ...
  return (
    <div id="systems-mobile-shell" data-mode={mode} className={styles.shell}>
      {backgroundImageUrl ? (
