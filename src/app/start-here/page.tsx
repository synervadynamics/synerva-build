        ...
        <div className="relative mx-auto max-w-5xl">
          <div className="glass-panel rounded-3xl border border-white/10 p-8 sm:p-10">
            <div className="space-y-4 text-base text-white/75 sm:text-lg">
              ...
              <p>
                I design and build strategy, brand, web, content, and automation
                as one coherent system — so decisions survive contact with
                reality and work actually ships.
              </p>
              <p>
              ...
              <div className="grid gap-6 md:grid-cols-3">
                <div className="glass-panel rounded-3xl border border-white/10 p-6 sm:p-7">
                  ...
                  <div className="mt-4 space-y-3 text-sm text-white/70">
                    ...
                    <p>You leave with sharper judgment and a clear next move.</p>
                ...
                <div className="glass-panel rounded-3xl border border-white/10 p-6 sm:p-7">
                  ...
                  <div className="mt-4 space-y-3 text-sm text-white/70">
                    <p>
                      A tightly scoped project with a defined outcome, timeline,
                      and price.
                    </p>
                    <p>No open-ended discovery.</p>
                    <p>No drifting scope.</p>
                    <p>
                      Best when you need something built, written, designed, or
                      structured — cleanly and decisively.
                    </p>
                  </div>
                </div>
                ...
                <div className="glass-panel rounded-3xl border border-white/10 p-6 sm:p-7">
                  ...
                  <div className="mt-4 space-y-3 text-sm text-white/70">
                    ...
                    <p>
                      This is for situations where fragmentation is the actual
                      problem — and fixing it requires cohesion, not
                      coordination.
                    </p>
                    <p>
          ...
          <div className="glass-panel rounded-3xl border border-white/10 p-8 sm:p-10">
            <div className="space-y-4 text-base text-white/70">
              ...
              <ul className="list-disc space-y-2 pl-5">
                ...
                <li>Brand systems that align identity, messaging, and execution</li>
                <li>Websites designed as operating surfaces, not brochures</li>
                <li>Long-form writing, positioning, and narrative assets</li>
                <li>Content and marketing systems that reduce coordination drag</li>
                <li>Automation that supports execution instead of complicating it</li>
              </ul>
              <p>
                Everything is treated as part of a single system — not a list of
                services.
              </p>
            </div>
          </div>
        ...
        <div className="relative mx-auto max-w-5xl space-y-6">
          <div className="glass-panel rounded-3xl border border-white/10 p-8 sm:p-10">
            ...
            <div className="mt-4 space-y-3 text-base text-white/70">
              ...
              <p>
                I confirm whether I’m the right fit — and how fast it can move.
              </p>
              <p>
