            ...
            <div className="grid gap-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)] lg:items-start">
              <div className="flex max-w-2xl flex-col gap-4">
                ...
                <div className="space-y-4 text-sm leading-snug text-white/80 sm:text-base">
                  <div className="space-y-2">
                    <h3 className="text-base text-white/85">Writing & Ghostwriting</h3>
                    <p>
                      Writing is treated as structure, not volume. Work focuses
                      on voice, logic, proof, and durability across revisions and
                    ...
                    <p>
                      ...
                      milestone-based delivery designed to hold up beyond draft
                      one.
                    </p>
                  </div>
                  <div className="space-y-2">
                    <h3 className="text-base text-white/85">Graphic Design</h3>
                    <p>
