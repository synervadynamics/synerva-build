...
export default function HomeMobileShell({
  ...
  return (
    <div id="home-mobile-shell" data-mode={mode} className={styles.shell}>
      {backgroundImageUrl ? (
      ...
      {showBackButton ? (
        isArtworkOpen ? (
          ...
          <Link href="/" aria-label="Back to mobile home" className={styles.backButton}>
            <span aria-hidden>←</span>
            <span>Home</span>
          </Link>
        )
