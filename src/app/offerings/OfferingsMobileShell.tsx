...
import styles from "./offeringsMobileShell.module.css";

const STORAGE_KEY = "offeringsMobileLayoutMode";
...
type OfferingsMobileShellProps = {
...
export default function OfferingsMobileShell({
  children,
  showBackButton = false,
  backgroundImageUrl,
  backgroundOverlayEnabled = true,
  backgroundOverlayOpacity = 1,
}: OfferingsMobileShellProps) {
  ...
  return (
    <div id="offerings-mobile-shell" data-mode={mode} className={styles.shell}>
      {backgroundImageUrl ? (
