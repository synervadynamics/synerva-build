      ...
      <section className="relative overflow-hidden px-6 py-16 sm:px-10 lg:px-16">
        ...
        <div className="relative mx-auto max-w-6xl space-y-8">
          <div className="space-y-2">
            <p className="text-xs uppercase tracking-[0.35em] text-white/60">Challenge · Solution · Results</p>
            <h2 className="text-3xl sm:text-4xl text-white">Proof that clarity outperforms chaos</h2>
          </div>
            ...
            {caseDetails.map(detail => (
              ...
              >
                <div className="flex items-center justify-between text-xs uppercase tracking-[0.3em] text-white/60">
                  ...
                  <span className="rounded-full bg-white/10 px-3 py-1 text-[0.65rem] text-white/70">Case</span>
                </div>
                ...
                <div className="mt-4 space-y-2 rounded-2xl border border-white/10 bg-white/5 p-4 text-white/75">
                  <p className="text-[0.7rem] uppercase tracking-[0.28em] text-white/60">Challenge</p>
                ...
                <div className="mt-3 space-y-2 rounded-2xl border border-white/10 bg-white/5 p-4 text-white/75">
                  <p className="text-[0.7rem] uppercase tracking-[0.28em] text-white/60">Solution</p>
                  <p className="text-sm">{detail.solution}</p>
                  <p className="text-[0.7rem] uppercase tracking-[0.28em] text-white/60">Systems</p>
                  <div className="flex flex-wrap gap-2">
                    {detail.systems.map(system => (
                      <span key={system} className="rounded-full border border-white/20 px-3 py-1 text-[0.75rem]">
                        {system}
                      </span>
                    ))}
                  </div>
                ...
                <div className="mt-3 space-y-2 rounded-2xl border border-white/10 bg-white/5 p-4 text-white/75">
                  <p className="text-[0.7rem] uppercase tracking-[0.28em] text-white/60">Results</p>
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    {detail.metrics.map(metric => (
                      <span key={metric} className="rounded-full bg-emerald-300/15 px-3 py-1 text-xs font-semibold text-emerald-200">
                        {metric}
                      </span>
                    ))}
                  </div>
