...
export default function InnerClimateGallery() {
  ...
  const showNext = useCallback(() => {
    setActiveIndex((idx) => {
      ...
      return (idx + 1) % innerClimateArtworks.length;
    });
  }, []);
  ...
  const showPrev = useCallback(() => {
    setActiveIndex((idx) => {
      if (idx === null) return idx;
      return (idx - 1 + innerClimateArtworks.length) % innerClimateArtworks.length;
    });
  }, []);
