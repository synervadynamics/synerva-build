...
type LabsVariant = "full" | "signup-only";

type LabsProps = {
  variant?: LabsVariant;
};

export const Labs = ({ variant = "full" }: LabsProps) => {
      ...
      <div ref={ref} className="relative mx-auto flex max-w-6xl flex-col gap-12">
        {!isSignupOnly && (
          ...
          >
            ...
            <div
              className="relative overflow-hidden rounded-[2.5rem] border border-white/12 bg-transparent p-4 shadow-[0_40px_140px_-80px_rgba(0,0,0,0.82)] backdrop-blur-2xl"
