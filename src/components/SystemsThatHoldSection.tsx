...
export const SystemsThatHoldSection = ({
  ...
  const content = (
    <div className="rounded-[28px] border border-[rgba(243,238,228,0.4)] bg-transparent px-7 py-10 shadow-[0_0_0_1px_rgba(243,238,228,0.2)] sm:px-9 sm:py-12 lg:px-10 lg:py-14">
