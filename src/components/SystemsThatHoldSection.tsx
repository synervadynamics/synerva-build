  ...
  const content = (
    <div className="flex flex-col gap-6 text-white">
      ...
      <div className={pairClassName}>
        <article className="flex h-full flex-col gap-4 rounded-[2rem] border border-white/12 bg-white/[0.03] p-4 shadow-[0_40px_140px_-90px_rgba(0,0,0,0.85)] backdrop-blur-xl sm:p-5 lg:p-6">
