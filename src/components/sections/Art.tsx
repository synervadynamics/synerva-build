        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div className="space-y-4">
              <h2 className="text-3xl text-white sm:text-4xl lg:text-5xl">Art That Understands What You&apos;re Made Of</h2>
              <p className="max-w-4xl text-lg text-white/72">{artCopy.tagline}</p>
              <p className="text-sm uppercase tracking-[0.3em] text-white/50">Series 001 — The Quiet Divine</p>
            </div>
            <Link
              href="/art#gallery"
