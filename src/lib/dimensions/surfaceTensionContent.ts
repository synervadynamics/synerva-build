export const surfaceTensionContent = {
  ...
  intro: [
    ...
    "Not in insight, but in exposure.\nNot in formation, but in continuity.",
    "These works examine what remains intact when a life reenters circulation.",
  ],
  acts: [
    {
      title: "Act I — After the Quiet",
      body: [
    ...
    {
      title: "Act III — Pressure Without Drama",
      body: [
    ...
    {
      title: "Act IV — What Strength Actually Is",
      body: [
