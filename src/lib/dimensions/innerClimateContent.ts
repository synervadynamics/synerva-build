export const innerClimateContent = {
  ...
  intro: [
    ...
    "What feels like instinct is often architecture.\nWhat feels like chance is often pattern.\nWhat feels deeply personal is often structural.",
    "This is not an interpretation of feeling. It is an observation of what feeling does to form.",
  ],
  acts: [
    {
      title: "Material as Evidence of Duration",
      body: [
    ...
    {
      title: "Interior Weather as Living Physics",
      body: [
    ...
    {
      title: "The Long Relationship Between Viewer and Work",
      body: [
        "These pieces are not designed for quick consumption. They are designed to live with you and shift as you shift.",
        "At distance, they read as environment.\nAt proximity, they read as structure.\nWith time, they begin to read as recognition.",
    ...
    },
    {
      ...
      body: [
        ...
        "If you want to be notified when works go live, receive early access, and unlock exclusive discounts, leave your email below.",
      ],
    },
  ],
};
