export const copy = {
    ...
    items: [
      ...
      },
      {
        ...
        description: [
          ...
          "The book was developed in close collaboration with Jasmine Pessendawatch, whose graduate work in counselling psychology grounds the pages in real therapeutic care without turning them clinical. The result is a tool that respects lived experience and psychological intelligence in equal measure.",
  ...
  systemsSection: {
    ...
    heading: "Systems",
    body:
      "Synerva is built around a simple advantage: decisions persist.\nStandards hold. Context compounds. Signal survives scale.\n\nA small set of internal systems captures real-world use across strategy and execution, translating experience into durable structure. What begins as judgment becomes repeatable, allowing work to stay coherent as complexity, scope, and time increase.\n\nThese systems absorb pressure without distortion, preserving intent while refining decisions through use. They reduce friction between thinking and execution, ensuring progress compounds instead of fragmenting as variables multiply. Clarity holds where it would otherwise erode.",
    developmentNote: "",
    cards: [
      {
        title: "Verisense",
  ...
  stack: {
    ...
    footnote:
      "(Adapted from the Synerva Dynamics Strategic Roadmap and Business Plan.)",
    items: [
      {
        title: "Lucentra",
      ...
      },
      {
        ...
        proof:
          "Delivers combined video and text analysis with consolidated sentiment reports for executive review.",
        highlights: [
          "Speech & presence diagnostics",
          "Tailored leadership coaching dossiers",
      ...
      },
      {
        ...
        proof:
          "Includes licensable playbooks and CASL-compliant communication layers in roadmap phases two and three.",
        highlights: [
  ...
  products: {
    lucentra: {
      ...
      image: {
        src: "/systems-logos/lucentra-subpage.png",
        label: "Lucentra crest and mark",
      },
    ...
    verisense: {
      ...
      image: {
        src: "/systems-logos/verisense-subpage.png",
        label: "Verisense crest and mark",
      },
    ...
    synervaOs: {
      ...
      image: {
        src: "/systems-logos/synerva-os-subpage.png",
        label: "Synerva OS crest and mark",
      },
  ...
  cases: {
    ...
    teasers: [
      {
        title:
          "Workflows compressed from scattered processes into one unified system.",
        line: "",
      },
      {
        title:
          "Communication transformed into insight with psychological analysis.",
        line: "",
      },
      {
        title:
          "Brands equipped with automation, clarity, and systems that compound results.",
        line: "",
      },
    ],
    details: [
      {
        ...
        industry: "B2B SaaS",
        summary:
          "Unified scattered GTM ops into one adaptive loop; doubled output without adding headcount.",
        challenge:
        ...
        metrics: [
          "+2.1× pipeline velocity",
          "-75% production cycle time",
          "-68% rework",
        ],
      ...
      },
      {
        ...
        summary:
          "Verisense surfaced subtext in interviews; better hires, faster cycles, higher candidate trust.",
        challenge:
      ...
      },
      {
        ...
        industry: "E-Commerce",
        summary:
          "Scaled consistent voice across 50+ weekly assets; engagement up, approvals down.",
        challenge:
  ...
  about: {
    ...
    p1: "Synerva Dynamics operates as a solo product studio with enterprise-grade discipline. Brand, UX, narrative, and code stay tightly aligned, so intent carries through to execution. Every system adheres to Canadian standards (en-CA language, CAD currency, CASL compliance). Every engagement runs on defined acceptance criteria, transparent pricing logic, and measurable lift.",
    ...
    phases: [
      {
        ...
        body: "Finalize the flagship site, release The Rockstar Server Playbook visuals, and deploy Lucentra and Verisense pilots for charter clients.",
        deliverables: [
          "World-class website launch",
          "Rockstar Playbook release + lead magnet",
          "Telemetry + intake automation stack.",
        ],
      },
      {
        title: "Phase 02 · Systems Deployment (Months 4–9)",
        timeframe: "Months 4–9",
        body: "Scale key initiatives into revenue programs, onboard Lucentra beta clients, and turn every engagement into licensable IP.",
        deliverables: [
          "Lucentra and Verisense betas live",
          "Synerva OS modules packaged and ready",
          "Case studies launched with public dashboards.",
        ],
      },
      {
        title: "Phase 03 · Studio + SaaS Hybrid (Months 10–12)",
        timeframe: "Months 10–12",
        body: "Shift from bespoke engagements to automated revenue streams powered by Synerva OS and governed by analytics.",
        deliverables: [
          "Recurring licensing deals",
          "Automation loops with closed-loop feedback",
          "Leadership dashboards + investor-ready proof.",
        ],
      },
    ],
  },
  ...
  contactProcess: [
    {
      ...
      detail:
        "You share the metrics that matter most. We map those friction points against the 12-month plan.",
    },
    {
      title: "Loop Blueprint",
      detail:
        "Lucentra and Synerva OS define how brand, web, content, automation, and analytics will all flow together.",
    },
    {
      title: "Launch Control",
      detail:
        "Weekly cinematic drops, analytics checks, and QA rituals keep results transparent and momentum on track.",
    },
  ],
  contactForm: {
    labels: {
    ...
    errorTemplate:
      "“Something went wrong. Please email synerva-dynamics@gmail.com.”",
  },
  footer: {
    legal: "© 2025 Synerva Dynamics. All rights reserved.",
    socials: [
      {
        label: "LinkedIn (@synerva-dynamics)",
        href: "https://www.linkedin.com/company/synerva",
      },
      {
        label: "Behance (@synerva-dynamics)",
        href: "https://www.behance.net/synerva",
      },
      {
        label: "Medium (@synerva-dynamics)",
        href: "https://medium.com/@synerva",
      },
    ],
    schema: {
